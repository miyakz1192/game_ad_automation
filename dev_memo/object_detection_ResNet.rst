...
4) ResNet34だと数十分類のみ。1000分類近くができそうなResNet50とか試してみる？

5) pytorch本家のチュートリアルの学習時のtransformだとrandom要素があるが、これ、不要じゃない？


2)については修正済み。1)はtransformを修正して、学習を実行開始(2023/01/26~)。3),4),5)については学習の結果と確認が済んでからやってみる。
...
結果は以下の通り。::
  ...
  a@pytorch:~/resset$ grep "(" res_close_20230127_edged.log  | awk -F "," '{print $1}' | sort | uniq -c | head -10
      202 (1000
        7 (1003
  a@pytorch:~/resset$ grep "(" res_not_close_20230127_edged.log  | awk -F "," '{print $1}' | sort | uniq -c | head -10
      875 (1000
       11 (1002
      215 (1003
        1 (203
...
closeに関しては認識率100%。ただし、非closeに関しては、誤認識率は改善せずの結果となった。
(4%悪化!)
  
エッジ化後::

  miyakz@lily:~$ ruby -e "puts (875+11+215)"
  1101
  miyakz@lily:~$ ruby -e "puts (875+11+215)/1281.0"
  0.8594847775175644
  miyakz@lily:~$ 
...
単純に考えると悪い結果を得たのだが、確信率をしきい値に考慮した場合にどうか？

edge前とedge後の結果の両方について考察してみる。::

  a@pytorch:~/resset$ ./bin/calc_exp.py  exp/res_20230127/res_close_20230127.log 
  INFO: gathering class than 1000 as 1000
  =====RECORD INFO=====
  total = 209
  =====SUM=====
  0.100000, 1000, 208, 99
  0.200000, 1000, 205, 98
  0.300000, 1000, 203, 97
  0.400000, 1000, 197, 94
  0.500000, 1000, 162, 77
  0.600000, 1000, 117, 55
  0.700000, 1000, 84, 40
  0.800000, 1000, 61, 29
  0.900000, 1000, 28, 13
  =====SUM(INVERT RAITIO)=====
  ...
  0.300000, 1000, 203, 2
  0.400000, 1000, 197, 5
  0.500000, 1000, 162, 22
  0.600000, 1000, 117, 44
  0.700000, 1000, 84, 59
  0.800000, 1000, 61, 70
  0.900000, 1000, 28, 86
  a@pytorch:~/resset$ ./bin/calc_exp.py  exp/res_20230127/res_not_close_20230127.log 
  INFO: gathering class than 1000 as 1000
  =====RECORD INFO=====
  total = 1281
  =====SUM=====
  0.100000, 1000, 847, 66
  0.200000, 1000, 817, 63
  0.300000, 1000, 787, 61
  0.400000, 1000, 735, 57
  0.500000, 1000, 639, 49
  0.600000, 1000, 550, 42
  0.700000, 1000, 513, 40
  0.800000, 1000, 447, 34
  0.900000, 1000, 360, 28
  =====SUM(INVERT RAITIO)=====
  0.100000, 1000, 847, 33
  0.200000, 1000, 817, 36
  0.300000, 1000, 787, 38
  0.400000, 1000, 735, 42
  0.500000, 1000, 639, 50
  0.600000, 1000, 550, 57
  0.700000, 1000, 513, 59
  0.800000, 1000, 447, 65
  0.900000, 1000, 360, 71
  a@pytorch:~/resset$ 

非edge入力だと確信度が0.4~0.5付近だと良いスコア(50%位の正答率)が得られそうな気がする。::

  a@pytorch:~/resset$ ./bin/calc_exp.py  exp/res_20230127/res_close_20230127_edged.log 
  INFO: gathering class than 1000 as 1000
  =====RECORD INFO=====
  total = 209
  =====SUM=====
  0.100000, 1000, 209, 100
  0.200000, 1000, 209, 100
  0.300000, 1000, 209, 100
  0.400000, 1000, 209, 100
  0.500000, 1000, 207, 99
  0.600000, 1000, 198, 94
  0.700000, 1000, 194, 92
  0.800000, 1000, 186, 88
  0.900000, 1000, 133, 63
  =====SUM(INVERT RAITIO)=====
  0.100000, 1000, 209, 0
  0.200000, 1000, 209, 0
  0.300000, 1000, 209, 0
  ...
  0.600000, 1000, 198, 5
  0.700000, 1000, 194, 7
  0.800000, 1000, 186, 11
  0.900000, 1000, 133, 36
  a@pytorch:~/resset$ ./bin/calc_exp.py  exp/res_20230127/res_not_close_20230127_edged.log 
  INFO: gathering class than 1000 as 1000
  =====RECORD INFO=====
  total = 1281
  =====SUM=====
  0.100000, 1000, 1101, 85
  0.200000, 1000, 1098, 85
  0.300000, 1000, 1083, 84
  0.400000, 1000, 1038, 81
  0.500000, 1000, 862, 67
  0.600000, 1000, 652, 50
  0.700000, 1000, 452, 35
  0.800000, 1000, 266, 20
  0.900000, 1000, 80, 6
  =====SUM(INVERT RAITIO)=====
  0.100000, 1000, 1101, 14
  0.200000, 1000, 1098, 14
  0.300000, 1000, 1083, 15
  0.400000, 1000, 1038, 18
  0.500000, 1000, 862, 32
  0.600000, 1000, 652, 49
  0.700000, 1000, 452, 64
  0.800000, 1000, 266, 79
  0.900000, 1000, 80, 93
  a@pytorch:~/resset$ 


この結果から、確信度が0.8以上であれば、closeであれば63~88%の確率で正答。非closeであれば、79~93%の確率で正答となる。
edgedであれば高い認識率になることがわかったため。現時点でのpytorch/ResNet34をGAAに組み込む。
